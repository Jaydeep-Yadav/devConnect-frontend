                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className='space-y-6'>
                        ...
                        <motion.button
                            ...
                            className='w-full bg-gradient-to-r from-blue-500 to-emerald-600 text-white font-bold py-3 px-4 rounded-lg shadow-lg hover:from-blue-600 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 disabled:opacity-50'
                        >
                            {isLoading ? "Verifying..." : "Verify Email"}
                        </motion.button>
                    </form>
                    {/* <div className='px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center'> */}
                    <div className='text-gray-400 pt-5 justify-center'>
                        <Link to='/login' className='text-white-400 hover:underline' >
                            Login to Resend Token
                        </Link>
                    </div>
                    {/* </div> */}
